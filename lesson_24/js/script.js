...
//  Область видимості працює і для функцій. Ящо змінна створена в тілі функцї, то її не буде видно за її межами.
// змінна може містити функцію. таке присвоєння буде мати назву функціональний вираз.
