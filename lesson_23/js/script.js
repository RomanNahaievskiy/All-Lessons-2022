...
// оператор додавання (складання/з'єднання) (+) не переводить тип даних  може скласти  різні типи даних якщо додати рядок до числа
...
console.log('    #- Інкремкнт & Декркмент - Миттєве додавання & віднімання:  ++var ');
